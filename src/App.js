    ...
    <>
      ...
      <Layout title="Layout 3" descr="Layout3 description" urlBg={LandscapeBg}>
        <p>
          ...
          labore voluptatum dignissimos ipsam ad, ea ipsa aperiam. Temporibus,
          dolorem.
        </p>
        <p>
          Hic iste earum, eius accusantium dolorem reprehenderit doloremque
          perspiciatis inventore ipsa. Fugit illo totam ipsum explicabo natus,
          quisquam et aspernatur laborum blanditiis corporis cupiditate saepe.
          Dolore est exercitationem quidem voluptatum aliquam quos numquam dicta
          ullam qui quas? Facere nulla minima illum, maiores nobis quidem sequi
          est quis! Incidunt excepturi esse autem, perferendis neque illo eum
          amet obcaecati error voluptate sequi facilis dolorem dignissimos!
          Modi, dolorum blanditiis iste fugiat, expedita facere aspernatur ut
          suscipit corrupti eos distinctio.
        </p>
      </Layout>
